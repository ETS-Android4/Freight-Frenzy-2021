...
public class AutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.strafe(0.8,(int)(-23*STRAFE_COUNTS_PER_INCH));
        ...
        robot.drive(0.3,(int)((7)*COUNTS_PER_INCH));
        robot.strafe(0.9,(int)((24*2 +7)*STRAFE_COUNTS_PER_INCH));
        robot.drive(0.8,(int)((-18)*COUNTS_PER_INCH));
        /*
        robot.strafe(0.9,(int)(24*STRAFE_COUNTS_PER_INCH));
        ...
        robot.drive(0.9,(int)(9*COUNTS_PER_INCH));
        robot.strafe(0.9,(int)(54*STRAFE_COUNTS_PER_INCH));
        robot.gyroTurn(1, 90, 0.01);
        //robot.drive(0.4,(int)(12*COUNTS_PER_INCH));
        //robot.strafe(0.4,(int)(6*STRAFE_COUNTS_PER_INCH));
        robot.strafe(0.3,(int)(2*STRAFE_COUNTS_PER_INCH));
        robot.CarouselMotor.setPower(-0.1);
        sleep(4000);
        robot.CarouselMotor.setPower(0);
        //robot.drive(0.9,(int)(18*COUNTS_PER_INCH));
        robot.strafe(0.9,(int)(-20*STRAFE_COUNTS_PER_INCH));
        //robot.drive(0.9,(int)(6*COUNTS_PER_INCH));
