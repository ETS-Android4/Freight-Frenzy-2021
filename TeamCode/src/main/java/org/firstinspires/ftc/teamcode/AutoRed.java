...
public class AutoRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.drive(0.3, (int)(4.8*COUNTS_PER_INCH));

        robot.gyroTurn(1, 0, 0.01);
        robot.strafe(0.8,(int)((-24*2 - 5)*STRAFE_COUNTS_PER_INCH));
        robot.gyroTurn(0.95, 180, 0.01);
        robot.drive(0.5, (int)(-8.2*COUNTS_PER_INCH));
        ...
        robot.drive(0.9, (int)(12*COUNTS_PER_INCH));
        robot.strafe(0.9,(int)((-24*2 - 6)*STRAFE_COUNTS_PER_INCH));
        robot.drive(0.9, (int)(-16*COUNTS_PER_INCH));

        /*
        robot.drive(0.9, (int)(48*COUNTS_PER_INCH));
        robot.gyroTurn(1, -180, 0.01);
        robot.drive(0.9, (int)(-11*COUNTS_PER_INCH));
        robot.drive(0.3, (int)(-3.5*COUNTS_PER_INCH));
        ...
        if(position== DuckPosition.CENTER){
            robot.extendArm(1, -2200);
        }
        if(position== DuckPosition.RIGHT) {
            //robot.drive(0.2,(int)(-1*COUNTS_PER_INCH));
            robot.extendArm(0.5, -2650);
        }
        ...
        robot.drive(0.9, (int)(2*COUNTS_PER_INCH));
        robot.strafe(1,(int)(-48*STRAFE_COUNTS_PER_INCH));
        robot.drive(0.9, (int)(-9.5*COUNTS_PER_INCH));
        ...
        /*
        robot.drive(0.9, (int)(COUNTS_PER_INCH));
        robot.gyroTurn(1, 180, 0.01);
        robot.drive(0.9, (int)(1.2*COUNTS_PER_INCH));
        robot.strafe(0.9,(int)(-25*STRAFE_COUNTS_PER_INCH));
        ...
        robot.strafe(0.9,(int)(-48*STRAFE_COUNTS_PER_INCH));

        robot.drive(1,(int)(14*COUNTS_PER_INCH));

        robot.drive(0.5,(int)(-3.5*COUNTS_PER_INCH));
        ...
        {
            case LEFT:
                robot.extendArm(0.7, 900);
                break;
            case CENTER:
                robot.extendArm(0.7, 1600);
                break;
            case RIGHT:
                robot.extendArm(0.7, 2500);
                break;
        }

        robot.strafe(1,(int)(-52*STRAFE_COUNTS_PER_INCH));
